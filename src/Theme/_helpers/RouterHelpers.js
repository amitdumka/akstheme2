...
//This is key which need to be changed for every and each project. other wise it will be sharing with same name.
const localStorageLastLocationKey = "aks-theme-lastLocation";
